...
#   editNamelistFile("arps.input", "arps.test.input")
    editNamelistFile("/home/tsupinie/arps5.3_20140211/input/radremap_88D.input", "radremap_88D.3km.new.input", __file_name_values__="radremap_88D.3km.input")
